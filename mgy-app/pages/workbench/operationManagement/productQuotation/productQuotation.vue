<template>
	...
	<view class="content" :style="{ 'padding-top': statusBarHeight + 'px' }">
		<u-navbar title="产品报价" bgColor="#fff" @leftClick="leftClick" @rightClick="toChoose(prop)">
		...
		<!-- 没数据时 -->
		<!-- <view v-if="lstProduct.length == 0" class="card">
			<view class="card-pa" @click="toDetail">
				<view class="card_top">

					<view class="left_image">
						<image src="/static/img/Frame 1556.png"></image>
					</view>
					<view class="contentBox">
						<text>尊贵钻石VIP年会员尊贵钻石VIP年会员尊贵钻石VIP年会员会员会员</text>
						<text class="code">CP20190808001</text>
						<view class="product_info">
							<text class="price">¥10,000.00元/年</text>
							<image src="/static/img/icon_anniu (2).png"></image>
						</view>
					</view>
				</view>
