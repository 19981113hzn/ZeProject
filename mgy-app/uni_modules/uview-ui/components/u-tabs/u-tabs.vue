			...
			<view class="u-tabs__wrapper__scroll-view-wrapper">
				...
				>
					...
					>
						...
						>
							<image
								v-if="(item.image && (item.image.direction=='left' && item.image.src))"
								:src="item.image && item.image.src"
								:style="{'width':(isWhether(item.image.width)?'18px': item.image.width),
								'height':(isWhether(item.image.height)?'18px': item.image.height),
								'right':'5px'}"
							...
							></u-badge>
							<image 
								v-if="(item.image && (item.image.direction=='right' && item.image.src))"
								:src="item.image && item.image.src"
								:style="{'width':(isWhether(item.image.width)?'18px': item.image.width),
								'height':(isWhether(item.image.height)?'18px': item.image.height),
								'left':'5px'}"
