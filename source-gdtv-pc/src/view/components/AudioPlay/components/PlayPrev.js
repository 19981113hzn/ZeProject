 ...
 * @extends Component
 */
class PlayPrev extends Component {
    ...
    createEl() {
        return super.createEl('button', {
            ...
            // 给元素加vjs-开头的样式名
            className: 'vjs-play-prev vjs-control',
            onclick: () => {
                this.player_.trigger('playPrev');
            }
        });
    }
